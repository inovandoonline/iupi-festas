...
@section('content')
    <div class="w-full bg-cover bg-no-repeat bg-fixed bg-center"
    ...
    <div class="container mx-auto -mt-10 mb-10">
        <div class="bg-white rounded-lg shadow-md py-6 px-4 md:mx-3 md:mx-auto w-full">
            <h1 class="w-full text-center text-4xl ps-b text-blue-light">Tema {{ $tema->title }}</h1>
            <div class="mt-6">
                ...
                <div class="flex flex-row flex-wrap justify-around border-t pt-4">
                    @foreach($tema->fotos as $img)
                        <a class="pb-2 px-1 w-1/3" href="{{ asset($img->imagem) }}" data-lightbox="fotos">
